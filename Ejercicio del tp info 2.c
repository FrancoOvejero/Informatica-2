...
switch(cambio_gir)//Los dos posibles casos del semaforo más el fin del programa
{
    ...
    sleep(t_espera*1000);//Delay del programa hasta la proxima fase
    printf("El semaforo habilito la luz de giro a la izquierda durante %d segundos \n", t_cambio);
    luzgiro=1;//Se habilita la luz de giro
    sleep(t_cambio*1000);//Delay del programa hasta la proxima fase
    ...
    break;
    case 1:{printf("El semaforo habilito la luz de giro a la izquierda durante %d segundos \n", t_cambio);
    sleep(t_cambio*1000);
